...
<body class="auth-page-body">
  ...
  <div class="auth-card">
    ...
    <div id="authViewMain">
      ...
      <div class="auth-social-divider">SOCIAL SIGN-IN COMING SOON</div>
      <div class="auth-social-row">
        <button type="button" class="btn-social-auth" style="flex:1; opacity:0.55; cursor:not-allowed;" disabled title="Google sign-in is coming soon" aria-label="Google sign-in (coming soon)">
        ...
        <button type="button" class="btn-social-auth" style="flex:1; opacity:0.55; cursor:not-allowed;" disabled title="Facebook sign-in is coming soon" aria-label="Facebook sign-in (coming soon)">
    ...
    <div id="authViewForgot" style="display:none;">
      <div style="text-align:center; margin-bottom:24px;">
        ...
        <p style="font-size:13px; color:rgba(255,255,255,0.65); margin:0 0 20px 0;">Self-service password reset is coming soon. For now, email our support team and we'll help you get back into your account.</p>
      ...
      <div style="text-align:center;">
        <a href="javascript:void(0)" onclick="showView('main')" style="font-size:13px; color:rgba(255,255,255,0.55); text-decoration:none;">← Back to Sign In</a>
      </div>
    </div>
  ...
  <script>
    ...
    function showView(view) {
      // This page has no OTP view: referencing one threw, so "Back to Sign In"
      // (which also asked for a non-existent 'signin' view) left it blank.
      const views = { main: 'authViewMain', 'forgot-password': 'authViewForgot' };
